...
class SiteController extends Controller {
 ...
 public function home(){ $b=$this->context->brand(); return view('site.home',['page'=>$b->pages()->published()->where('type','home')->firstOrFail(),'services'=>$b->services()->published()->orderBy('sort_order')->limit(3)->get(),'courses'=>$b->courses()->published()->orderBy('sort_order')->limit(3)->get(),'links'=>$b->links()->get()]); }
 public function about(){return view('site.about',['page'=>$this->context->brand()->pages()->published()->where('type','about')->firstOrFail()]);}
