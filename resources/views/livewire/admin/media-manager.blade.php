<section class="admin-panel media-manager">
    ...
    <form wire:submit="saveUploads" class="upload-form">
        <label>選擇圖片<input type="file" wire:model="uploads" accept="image/jpeg,image/png,image/webp" multiple>
        </label>
        ...
        @error('uploads')
            ...
            <p class="field-error">{{ $message }}</p>
        @enderror
        <button class="admin-button" type="submit" wire:loading.attr="disabled">
            <span wire:loading.remove>上傳圖片</span>
